    ...
    switch (type) {
      case 'booking':
        emailData = {
          ...
          reply_to: 'pkangourou@outlook.fr',
        };
        break;
    ...
    <html>
      ...
      <body>
        <div class="container">
          ...
          <div class="footer">
            <p>📍 Versailles, France | 📧 pkangourou@outlook.fr | 📞 06 XX XX XX XX</p>
...
function generateContactEmail(data: any): string {
  return `
    <!DOCTYPE html>
    <html>
      <head>
